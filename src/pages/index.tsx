...
import api from "./api";
import { Box, Flex, Heading, Img, useDisclosure, Text } from "@chakra-ui/react";
    ...
    <>
      ...
      <Box px={2}>
              ...
              {popular.results.map((popularMovie) => (
                <>
                  <SwiperSlide key={popularMovie.id}>
                    <Flex gap={4} mx={4} bg="gray.700">
                      <Box position="relative" height="md" width="50%">
                        <Img
        ...
        <Flex direction="column" gap={10} mb={10}>
          <Box as="section" bg={"gray.700"} p={4} mx={4} borderRadius={4}>
...
function defineColorChart(vote_average: number) {
